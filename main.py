...
channels = [
    ...
    {"name": "CNN Indonesia", "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/CNN_Indonesia.svg/1200px-CNN_Indonesia.svg.png", "group": "TV Berita", "url: "https://live.cnnindonesia.com/livecnn/smil:cnntv.smil/chunklist_w1736510455_b384000_sleng.m3u8|User-Agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"},"},
